...
namespace Traverser
{
    public class TraverserWallObject
    {
        ...
        public struct TraverserWallGeometry
        {
            ...
            public void Initialize(TraverserAffineTransform contactTransform)
            {
                ...
                float minimumDistance = math.abs(PlaneDistance(normal, Vector3.up, localPosition));
                ...
                for (int i = 1; i < 4; ++i)
                {
                    ...
                    float distance = math.abs(PlaneDistance(n, Vector3.up, localPosition));
            ...
            {
                return ((inverseTransformPoint(p) - center) * (1/size)) * 2.0f;
            }
            ...
            public float3 GetOrthogonalLocalSpace()
            {
                ...
                return math.cross(normal, Vector3.up);
            }
            ...
            public float3 GetBaseVertex()
            {
                ...
                return normal + up + GetOrthogonalLocalSpace();
            }
            ...
            public float3 GetPosition(TraverserWallAnchor anchor)
            {
                ...
                float3 vertex0World = transformPoint(center + size * vertex * 0.5f);
                ...
                float3 up = Vector3.up;
                return vertex0World - (orthogonalWorld * xLocal) - (up * yLocal);
            }
            ...
            public TraverserWallAnchor GetAnchor(float3 position)
            {
                ...
                float distance = math.abs(PlaneDistance(normal, Vector3.up, localPosition));
            ...
            public void DebugDraw()
            {
                ...
                for (int i = 0; i < 4; ++i)
                {
                    ...
                    float3 v0 = transformPoint(center + size * vertex * 0.5f);
                    float3 v1 = transformPoint(center + size * nextVertex * 0.5f);
